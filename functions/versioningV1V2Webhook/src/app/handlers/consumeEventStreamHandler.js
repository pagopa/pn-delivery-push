            ...
            if (data.element){
                switch(version) {
                    case 10:
                        ...
                        responseBody.push(createProgressResponseV10(createProgressResponseV23(createProgressResponseV24(createProgressResponseV27(data)))));
                    break;
                    case 23:
                        console.debug('Mapping to v23')
                        responseBody.push(createProgressResponseV23(createProgressResponseV24(createProgressResponseV27(data))));
                    break;
                    case 24:
                        console.debug('Mapping to v24')
                        responseBody.push(createProgressResponseV24(createProgressResponseV27(data)));
                    break;
                    case 25:
