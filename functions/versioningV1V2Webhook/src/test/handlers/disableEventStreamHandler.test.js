...
describe("DisableEventStreamHandler", () => {
    ...
    describe("handlerEvent", () => {
        ...
        it("successful request 2.7", async () => {

            process.env = Object.assign(process.env, {
                PN_WEBHOOK_URL: "https://api.dev.notifichedigitali.it/delivery-progresses/v2.8",
            });
            ...
            const b = '{}'
            const event = {
                path: "/delivery-progresses/v2.7/streams/{streamId}/action/disable",
                pathParameters : { streamId: streamId },
                httpMethod: "PUT",
                headers: {},
                requestContext: {
            ...
            mock.onPost(url).reply(200, responseBodyV27);
