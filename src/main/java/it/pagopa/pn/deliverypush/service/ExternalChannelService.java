...
public interface ExternalChannelService {
    void sendDigitalNotification(Notification notification, DigitalAddress digitalAddress, DigitalAddressSource2 addressSource, NotificationRecipient recipient, int sentAttemptMade);
