...
public class TimelineElementMapper {
    ...
    public static TimelineElementV28 internalToExternal(TimelineElementInternal internalDto) {
        var builder = TimelineElementV28.builder()
                .category(internalDto.getCategory() != null ? TimelineElementCategoryV28.fromValue( internalDto.getCategory().getValue() ) : null)
                ...
                .details( SmartMapper.mapToClass(internalDto.getDetails(), TimelineElementDetailsV28.class) );
