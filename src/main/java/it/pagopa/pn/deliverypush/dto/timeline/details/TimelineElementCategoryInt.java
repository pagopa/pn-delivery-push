...
public enum TimelineElementCategoryInt {
    ...
    VALIDATE_F24_REQUEST(ValidateF24Int.class, TimelineElementCategoryV20.VALIDATE_F24_REQUEST.getValue(), TimelineElementCategoryInt.VERSION_20),
    ...
    VALIDATED_F24(ValidatedF24DetailInt.class, TimelineElementCategoryV20.VALIDATED_F24.getValue(), TimelineElementCategoryInt.VERSION_20),
