...
public class PnF24ClientImpl extends CommonBaseClient implements PnF24Client {
    ...
    @Override
    public Mono<RequestAccepted> validate(ValidateF24Request validateF24Request, String xPagopaF24CxId) {
        log.logInvokingAsyncExternalService(CLIENT_NAME, VALIDATE_F24_PROCESS_NAME, "correlationId");
        return f24ControllerApi.validateMetadata(xPagopaF24CxId, validateF24Request.getSetId(), validateF24Request);
    }
}