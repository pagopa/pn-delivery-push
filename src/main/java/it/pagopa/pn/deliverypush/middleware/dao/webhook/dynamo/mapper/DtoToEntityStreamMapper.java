...
public class DtoToEntityStreamMapper {
    ...
    public static StreamEntity dtoToEntity(String paId, String streamId, String version, StreamRequestV28 dto) {
        StreamCreationRequestV28 creationRequestv26 = new StreamCreationRequestV28();
        BeanUtils.copyProperties(dto, creationRequestv26);
        creationRequestv26.setEventType(StreamCreationRequestV28.EventTypeEnum.fromValue(dto.getEventType().getValue()));
