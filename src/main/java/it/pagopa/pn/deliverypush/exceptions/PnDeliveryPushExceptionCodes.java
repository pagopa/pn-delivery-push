...
public class PnDeliveryPushExceptionCodes extends PnExceptionsCodes {
    ...
    public static final String ERROR_CODE_DELIVERYPUSH_GENERATEAARPDFFAILED = "PN_DELIVERYPUSH_GENERATEAARPDFFAILED";
    ...
    public static final String ERROR_CODE_DELIVERYPUSH_JSON_FAILED = "PN_DELIVERYPUSH_JSONFAILED";
}
