...
public class PnDeliveryPushExceptionCodes extends PnExceptionsCodes {
    ...
    public static final String ERROR_CODE_DELIVERYPUSH_FUTURE_ACTION_NOTFOUND= "PN_DELIVERYPUSH_FUTURE_ACTION_NOTFOUND";
    public static final String ERROR_CODE_DELIVERYPUSH_ACTION_CONFLICT = "PN_DELIVERYPUSH_ACTION_CONFLICT";
