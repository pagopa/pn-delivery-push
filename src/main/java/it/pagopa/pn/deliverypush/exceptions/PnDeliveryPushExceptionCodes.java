...
public class PnDeliveryPushExceptionCodes extends PnExceptionsCodes {
    ...
    public static final String ERROR_CODE_DUPLICATED_ITEMD = "PN_DELIVERYPUSH_DUPLICATED_ITEM";
    public static final String ERROR_CODE_NOTIFICATION_RECIPIENTS_TOKEN_FAILED = "PN_DELIVERYPUSH_NOTIFICATIONRECIPIENTSTOKENFAILED";
