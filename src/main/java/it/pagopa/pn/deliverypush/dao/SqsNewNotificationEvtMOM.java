...
public class SqsNewNotificationEvtMOM extends GenericSqsMOM<NewNotificationEvt> implements NewNotificationEvtMOM {
    ...
    public SqsNewNotificationEvtMOM(SqsAsyncClient sqs, ObjectMapper objMapper, PnDeliveryPushConfigs cfg) {
        super( sqs, objMapper, NewNotificationEvt.class, cfg.getTopics().getNewNotifications() );
    }
