...
bash <(curl -s https://raw.githubusercontent.com/pagopa/pn-delivery-push/da6a0d3ade7c15211000d11f326336a441add1df/src/test/resources/testcontainers/init.sh)
