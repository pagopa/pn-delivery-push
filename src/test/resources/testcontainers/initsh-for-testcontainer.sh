...
bash <(curl -s https://raw.githubusercontent.com/pagopa/pn-delivery-push/35a82938b7830ce7feedf38aed70a0c5c8e7b03b/src/test/resources/testcontainers/init.sh)
