...
class TimelineEventIdBuilderTest {
    ...
    void buildSEND_DIGITAL_PROGRESSTest() {
        ...
        String timeLineEventIdExpected = "digital_delivering_progress-IUN_123456789-RECINDEX_1-SOURCE_PLATFORM-SENTATTEMPTMADE_1-PROGRESSINDEX_1-";
        String timeLineEventIdActual = new TimelineEventIdBuilder()
    ...
    void buildSEND_DIGITAL_DOMICILETest() {
        ...
        String timeLineEventIdExpected = "send_digital_domicile-IUN_123456789-RECINDEX_1-SOURCE_PLATFORM-";
        String timeLineEventIdActual = new TimelineEventIdBuilder()
