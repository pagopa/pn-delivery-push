...
@ContextConfiguration(classes = SentAttachmentAnalogAarDocumentPaymentOldAAR.InnerTestConfiguration.class)
class SentAttachmentAnalogAarDocumentPaymentOldAAR extends SendAarAttachment {
