...
class AttachmentUtilsTest {
    ...
    void init(){
        ...
        paperSendModeUtils = Mockito.mock(PaperSendModeUtils.class);
        ...
        attachmentUtils = new AttachmentUtils(safeStorageService, pnDeliveryPushConfigs, notificationProcessCostService, paperSendModeUtils);
