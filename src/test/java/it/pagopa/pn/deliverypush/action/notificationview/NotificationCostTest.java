...
class NotificationCostTest {
    ...
    void getNotificationCostWithRefinement() {
        ...
        //THEN
        Mockito.verify(notificationCostService, Mockito.never()).getPagoPaNotificationBaseCost();
    ...
    void getNotificationCostWithoutRefinement() {
        ...
        int expectedCost = 10;
        Mockito.when(notificationCostService.getPagoPaNotificationBaseCost()).thenReturn(Mono.just(expectedCost));
        ...
        Mockito.verify(notificationCostService).getPagoPaNotificationBaseCost();
    }
}
