...
class NotificationPaidTestIT {
 ...
 /*
       ...
       - Viene visualizzata la notifica, questo comporta che nessun invio analogico avvenga
     */
        ...
        PnDeliveryPaymentEvent.Payload paymentEventPayload = simulateNotificationPaid(iun, recIndex);
    ...
    private PnDeliveryPaymentEvent.Payload simulateNotificationPaid(String iun, int recIndex) {
