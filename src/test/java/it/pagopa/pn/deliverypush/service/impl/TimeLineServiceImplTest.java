...
//        timeLineService = new TimeLineServiceImpl(timelineDao , timelineCounterDao , statusUtils, confidentialInformationService, statusService, schedulerService, notificationService);
    ...
    void getTimelineWithoutDiagnosticElements() {
        ...
        //Verifica timeline
        List<TimelineElementV24> timelineElementList = notificationHistoryResponse.getTimeline();
    ...
    private boolean timelineElementContainsElementId(List<TimelineElementV24> timelineElements, String elementId) {
