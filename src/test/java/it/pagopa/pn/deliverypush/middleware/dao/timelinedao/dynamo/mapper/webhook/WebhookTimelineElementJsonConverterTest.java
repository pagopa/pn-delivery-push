...
class WebhookTimelineElementJsonConverterTest {
    ...
    private WebhookTimelineElementJsonConverter converter = new WebhookTimelineElementJsonConverter(objectMapper);
    ...
    void test_convertJsonEntity() {
        ...
        """;
        WebhookTimelineElementEntity timelineElementEntity = converter.jsonToEntity(jsonResult);
